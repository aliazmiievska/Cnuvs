            ...
            <div className="grid md:grid-cols-3 gap-8">
                <div>
                    ...
                    <ul className="space-y-2">
                        <li><a href="#" className="text-gray-400 hover:text-white transition">Клацай, щоб переглянути</a></li>
                        ...
                        <li><a href="#" className="text-gray-400 hover:text-white transition">X (Twitter)</a></li>
                    </ul>
                </div>
